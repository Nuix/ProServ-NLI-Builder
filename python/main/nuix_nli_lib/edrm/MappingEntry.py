...
class MappingEntry(EntryInterface):
    ...
    def __init__(self, mapping: dict[str, Any], mimetype: str, parent_id: Optional[str] = None) -> None:
        """
    ...
    def __fill_initial_fields(self) -> None:
        """
    ...
    def __fill_generic_fields(self, mimetype: str) -> None:
        ...
        sha1_hash = eutes.hash_data(data_to_hash, hashlib.sha1())
    ...
    def itemdate(self) -> Union[datetime, str]:
        ...
        if time_field is None:
            ...
            if isinstance(date_time, str):
                fmt = str(edrm.configs['date_time_format'])
                try:
                    time_as_datetime: Union[datetime, str] = datetime.strptime(date_time, fmt)
                except ValueError:
                    time_as_datetime = fmt
    ...
    def calculate_md5(self) -> str:
        result = eutes.hash_data(self.text, hashlib.md5())
