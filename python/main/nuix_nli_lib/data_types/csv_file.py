...
class CSVEntry(FileEntry):
    ...
    def __init__(self, file_path: str,
        ...
        # Read only the header row to populate field names eagerly.  This validates the file format
        # immediately (matching the original behaviour) without loading all row data.
